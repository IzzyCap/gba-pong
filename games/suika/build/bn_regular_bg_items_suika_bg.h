...
#define suika_bg_bn_gfxTilesLen 448
extern const bn::tile suika_bg_bn_gfxTiles[14];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item suika_bg(
            regular_bg_tiles_item(span<const tile>(suika_bg_bn_gfxTiles, 14), bpp_mode::BPP_4, compression_type::NONE), 
