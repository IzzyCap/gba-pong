...
//
//	Time-stamp: 2026-07-13, 17:57:40
...
#define suika_game_zone_bn_gfxTilesLen 2464
extern const bn::tile suika_game_zone_bn_gfxTiles[77];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item suika_game_zone(
            regular_bg_tiles_item(span<const tile>(suika_game_zone_bn_gfxTiles, 77), bpp_mode::BPP_4, compression_type::NONE), 
